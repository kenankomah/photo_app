...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducer_images = __webpack_require__(262);

	var _reducer_images2 = _interopRequireDefault(_reducer_images);

	var _reducer_active_image = __webpack_require__(265);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _imageDetail = __webpack_require__(264);

	var _imageDetail2 = _interopRequireDefault(_imageDetail);

	var _imageList = __webpack_require__(261);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _id_export = __webpack_require__(263);
...
/***/ (function(module, exports) {
	...
	exports.default = function () {
		var request = fetch('http://localhost:8000/books', { credentials: 'include' }).then(function (res) {
			return res.json();
		});
...
/***/ (function(module, exports) {
	...
	exports.default = function () {
	  //  window.location.assign('http://localhost:8000/auth/login');
	  //debugger;
	  var request = fetch('http://localhost:8000/mongoid', { credentials: 'include' }).then(function (res) {
	    return res.json();
	  }).catch(function (error) {
	    return window.location.assign('http://localhost:8000/auth/login');
	  });
	  return { payload: request };
	};
	  ...
	  _createClass(ImageDetail, [{
	    ...
	    value: function deleteImage(id) {
	      var newPost = function newPost() {
	        ...
	        return fetch('http://localhost:8000/book/' + id, options).then(function (res) {
	          return res.json();
	        }).then(function (res) {
